...
from agent.workflows.patent.prompts import PATENT_DOMAIN_PROMPT
from agent.workflows.patent.renderers import render_patent_markdown
from agent.workflows.patent.reviewers import PatentReviewGate
from agent.workflows.patent.schemas import (
    ClaimNode,
    ClaimTree,
    PatentRiskNote,
    PriorArtItem,
...
from agent.workflows.patent.tools import browser_verify_patent_page, get_patent_tools
...
async def build_deepagents_patent_agent() -> object:
    ...
    from agent.workflows.patent.prompts import (
