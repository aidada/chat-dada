...
from domain_agents.research.config import DEFAULT_REPORT_PROFILE, ResearchConfig, ResearchState
from domain_agents.research.prompts import _build_research_messages, _looks_like_academic_paper_task
from domain_agents.research.utils import _generate_structured_summary, _latest_tool_messages, _synthesize_parallel_findings
...
def build_parallel_research_graph():
    ...
    async def parallel_research_node(state: ResearchState) -> dict:
        ...
        from domain_agents.research.worker import coordinate_research
